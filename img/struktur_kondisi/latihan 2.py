# variabel angka menampung jumlah angka yang di inputkan berupa array/list
angka = []

#variabel bilangan untuk menentukan jumlah bilangan yang diingkan 

bilangan = input("Masukkan jumlah bilangan yang diingkan: ")
